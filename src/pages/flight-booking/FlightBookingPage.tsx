    ...
    <div className="m-auto w-full max-w-[1272px] px-4 ">
      ...
      <div className="mb-[72px] grid grid-cols-1 md:grid-cols-2 gap-6 ">
        ...
        <div className="w-full max-w-[510px] mx-auto ">
          <div className="text-base font-medium flex flex-col lg:flex-row gap-4">
            <p className="rounded-full bg-blue-50 flex gap-2 items-center py-4 px-4 ">
              <img src={arrowRounded} alt="arrow icon" /> Round Trip
            </p>
            <p className="rounded-full bg-gray-100 flex gap-2 items-center py-4 px-4">
