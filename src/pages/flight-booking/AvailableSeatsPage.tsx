  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      navigate("/flight/confirm", {
        state: { seatNo: values.seat, price: data.price },
      });
    } catch (error) {
  ...
  return (
    <div className="m-auto w-full max-w-[1272px] px-4">
      ...
      <div className="mb-[72px] grid grid-cols-1 md:grid-cols-2 gap-6 ">
        ...
        <div className="mb-6">
          <h2 className="text-lg font-medium text-center mb-4">Choose seat</h2>
          <ul className="flex justify-between md:flex-row gap-4 flex-col text-xl text-gray-900">
