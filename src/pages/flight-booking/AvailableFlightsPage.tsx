            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {data.map((obj) => (
                    <li key={obj.id}>
                        ...
                        >
                            <p className="flex justify-between font-medium text-gray-900 text-lg">
                                <span>{formatTime(obj.departure_time)}</span>
                                <span>{formatTime(obj.arrival_time)}</span>
                            </p>
                            <p className="flex justify-between  font-medium text-gray-500 text-lg">
                                <span>
                                    {obj.from.slice(0, 3).toUpperCase()}
                                </span>
