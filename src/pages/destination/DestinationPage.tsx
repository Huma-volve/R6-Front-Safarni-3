  ...
  return (
    <>
      <div className="m-auto w-full max-w-[1272px] px-4">
        ...
        <div className="mb-10">
          <h2 className="font-medium text-2xl mb-4">Top Activities</h2>
        ...
        <div className="mb-10">
          <h2 className="font-medium text-2xl mb-4">Best Time to Visit</h2>
      ...
      <div className="py-12 mt-10 shadow-[0_-10px_15px_0px_theme(colors.gray.200)]">
        <div className="grid md:grid-cols-2 gap-4 justify-between items-center m-auto w-full max-w-[1272px] px-4">
          <p className="text-2xl">
            Total Price:{" "}
            <span className="text-blue-700 font-bold">${tourData?.price}</span>
